...
<Tabs items={['React Native', 'Flutter']}>
  ...
  <Tabs.Tab>
    <Steps>
      ### Fetch Portfolio
      First, let's create a new screen with the name `user_portfolio.dart`. Fetch the user portfolio details using [`getPortfolio`](/sdk-reference/getPortfolio) from Okto and store them in a state.
